...
// import getToken from '@/utils/getTtsToken.js';

// API URL and credentials
const url = 'https://sami.bytedance.com/api/v1/invoke';
const appkey = 'VxylhBwyDv';
let token = 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..R6g5oC-TEJRZ6Itff6fl1ejJK1iEIcd-VO9iOauQDkKFQmB_S0lm_E95G_a1cJHGdV1z5sXX4XhJbXSVh-48vQ';
